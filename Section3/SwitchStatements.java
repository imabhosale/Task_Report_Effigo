    ...
    public static void main(String[] args) {
        ...
        switch (weather) {
            case "sunny":
                ...
                break;
            case "cloudy":
                System.out.println("you should wear sweater");
                break;
            case "rainy":
                System.out.println("You can wear raincoat");
                break;
            
            case "snowy":
                System.out.println("you can wear jacket");
                break;
        ...
        switch (role) {
            ...
            default:
                System.out.println(":you can contact to HR");
        }
